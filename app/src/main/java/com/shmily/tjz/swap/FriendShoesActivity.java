...
public class FriendShoesActivity extends AppCompatActivity {
...
//        getcollect();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friend_shoes);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case WHAT_NEWSS:
                        ...
                        Glide.with(FriendShoesActivity.this).load(headimage_url).into(headimage);
                        ...
                        discuss.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent=new Intent(FriendShoesActivity.this,DiscussActivity.class);
                                intent.putExtra("discuss_shoes_id",String.valueOf(shoesList.get(0).getId()));
                                intent.putExtra("discuss_showimage",shoesimageurl);
                                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(FriendShoesActivity.this).toBundle());
...
//        DataSupport.deleteAll(DiscussAllLite.class);
        ...
        xutils.post(url, maps, new Xutils.XCallBack() {
            ...
            public void onResponse(String result) {
                try {
                    ...
                    Glide.with(FriendShoesActivity.this).load(url).into(discuss_headimage);
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case WHAT_NEWS:
                            ...
                            LinearLayoutManager layoutManger =new LinearLayoutManager(FriendShoesActivity.this);
   ...
   /*     MultiColumnListView multicolumn = (MultiColumnListView) findViewById(R.id.show_sec_list);
        ...
        LinearLayoutManager layoutManager=new LinearLayoutManager(FriendShoesActivity.this);
